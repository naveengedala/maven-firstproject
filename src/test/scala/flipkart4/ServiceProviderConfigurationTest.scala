...
import flipkart4.reader.mycomponent.MyStreamReaderImpl
import flipkart4.transformer.mycomponent.MyStreamTransformerImpl
import flipkart4.writer.mycomponent.MyStreamWriterImpl
